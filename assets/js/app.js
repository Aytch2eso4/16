...
// Retrieve data from everything below
(async function () {
    ...
    // create text Group, append a statetext field for labels for the circles
    // state text format defined in d3Style.css 
    ...
    labelsYGroup.selectAll("text")
        .on("click", function () {
            ...
            if (value !== chosenYAxis) {
                ...
                // updates text labels with new y 
